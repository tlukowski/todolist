    ...
    return (      
        <div className='flex flex-col items-center'>
          ...
          <div className='mt-24'>
            ...
            <div className='mt-10'>
            <Link className='relative group bg-primary text-white py-[14px] w-full block rounded-[14px] hover:bg-violet-900 transition-colors duration-300] text-center' to='/register'>
