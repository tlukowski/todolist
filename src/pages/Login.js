    ...
    return (
      <div className='w-[375px] mx-auto py-16 border-4 border-black rounded-2xl mt-5'>
        <div className='flex flex-col items-center'>
          <div className='mt-24'>
            <h2 className="text-2xl font-semibold text-center max-w-[240px]">Task Management & 
            To-Do List</h2>
            ...
            <div className='mt-10'>
            <div className='relative group bg-primary text-white py-[14px] w-full block rounded-[14px] hover:bg-violet-900 transition-colors duration-300] text-center' to='/login'>             
                Let's Start
